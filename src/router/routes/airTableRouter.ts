...
class AirTableRouter {
     ...
     */
        ...
        this.router.get('/airtable/reportes', async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                var response = await this.service.GetReportes(estado, aseguradora, agente);
        ...
        *         description: Error interno del servidor.
        */
        this.router.get('/airtable/usuarios', async (req: Request, res: Response, next: NextFunction) => {
            try {
        ...
        *         description: Error interno del servidor.
        */
        this.router.get('/airtable/titulares', async (req: Request, res: Response, next: NextFunction) => {
            try {
        ...
        *         description: Error interno del servidor.
        */
        this.router.get('/airtable/seguros', async (req: Request, res: Response, next: NextFunction) => {
            try {
