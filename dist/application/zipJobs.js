...
function ensureUploadFolders() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ROOT = ((_a = process.env.UPLOADS_ROOT) === null || _a === void 0 ? void 0 : _a.trim()) || path_1.default.join(HOME, "nodeapp_uploads");
...
function extractPdfBuffer(row) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        // 1) archivo en disco
        const filePath = (_a = row.path_consentimiento) !== null && _a !== void 0 ? _a : undefined;
        if (filePath) {
            try {
            ...
            catch ( /* ignora, continua con blob/base64 */_b) { /* ignora, continua con blob/base64 */ }
        }
        // 2) blob
        if (row.consentimiento) {
            const val = row.consentimiento;
...
function runZipOnBoot() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const lockPath = path_1.default.join(ZIP_DIR, ".zip.lock");
        const releaseLock = () => __awaiter(this, void 0, void 0, function* () { try {
            yield promises_1.default.rm(lockPath, { force: true });
        }
        catch (_a) { } });
        try {
            yield promises_1.default.writeFile(lockPath, String(Date.now()), { flag: "wx" }); // falla si ya existe
        }
        catch (_c) {
        ...
        try {
            ...
            const data = Array.isArray(resp) ? resp : ((_b = resp === null || resp === void 0 ? void 0 : resp.data) !== null && _b !== void 0 ? _b : []);
