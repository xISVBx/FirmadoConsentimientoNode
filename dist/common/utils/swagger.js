...
const swaggerOptions = {
    ...
    apis: [
        path_1.default.join(process.cwd(), "src/router/routes/*.ts"), // dev
        path_1.default.join(process.cwd(), "dist/router/routes/*.js"), // prod compilado
        path_1.default.join(process.cwd(), "src/server.ts"), // 👈 agrega esto (ajusta nombre si difiere)
        path_1.default.join(process.cwd(), "dist/server.js"), // 👈 para producción compilada
    ],
};
